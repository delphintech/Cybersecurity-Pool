   ...
   0x000055555555532f <+15>:	lea    rdi,[rip+0xd0d]        # 0x555555556043
   ...
   0x0000555555555341 <+33>:	lea    rdi,[rip+0xd0e]        # 0x555555556056
   ...
   0x00005555555553a0 <+128>:	lea    rdi,[rbp-0x21]
   0x00005555555553a4 <+132>:	xor    esi,esi
   0x00005555555553a6 <+134>:	mov    edx,0x9
   0x00005555555553ab <+139>:	call   0x555555555060 <memset@plt>
   0x00005555555553b0 <+144>:	mov    BYTE PTR [rbp-0x21],0x2a
   0x00005555555553b4 <+148>:	mov    BYTE PTR [rbp-0x41],0x0
   0x00005555555553b8 <+152>:	mov    QWORD PTR [rbp-0x18],0x2
   0x00005555555553c0 <+160>:	mov    DWORD PTR [rbp-0xc],0x1
   0x00005555555553c7 <+167>:	lea    rdi,[rbp-0x21]
   ...
   0x00005555555553fa <+218>:	cmp    rax,rcx
   ...
   0x0000555555555406 <+230>:	test   al,0x1
   0x0000555555555408 <+232>:	jne    0x555555555413 <main+243>
   0x000055555555540e <+238>:	jmp    0x555555555461 <main+321>
   0x0000555555555413 <+243>:	mov    rax,QWORD PTR [rbp-0x18]
   0x0000555555555417 <+247>:	mov    al,BYTE PTR [rbp+rax*1-0x40]
   0x000055555555541b <+251>:	mov    BYTE PTR [rbp-0x44],al
   0x000055555555541e <+254>:	mov    rax,QWORD PTR [rbp-0x18]
   0x0000555555555422 <+258>:	mov    al,BYTE PTR [rbp+rax*1-0x3f]
   0x0000555555555426 <+262>:	mov    BYTE PTR [rbp-0x43],al
   0x0000555555555429 <+265>:	mov    rax,QWORD PTR [rbp-0x18]
   0x000055555555542d <+269>:	mov    al,BYTE PTR [rbp+rax*1-0x3e]
   0x0000555555555431 <+273>:	mov    BYTE PTR [rbp-0x42],al
   0x0000555555555434 <+276>:	lea    rdi,[rbp-0x44]
   0x0000555555555438 <+280>:	call   0x555555555090 <atoi@plt>
   0x000055555555543d <+285>:	mov    cl,al
   0x000055555555543f <+287>:	movsxd rax,DWORD PTR [rbp-0xc]
   0x0000555555555443 <+291>:	mov    BYTE PTR [rbp+rax*1-0x21],cl
   0x0000555555555447 <+295>:	mov    rax,QWORD PTR [rbp-0x18]
   0x000055555555544b <+299>:	add    rax,0x3
   0x000055555555544f <+303>:	mov    QWORD PTR [rbp-0x18],rax
   0x0000555555555453 <+307>:	mov    eax,DWORD PTR [rbp-0xc]
   0x0000555555555456 <+310>:	add    eax,0x1
   ...
   0x000055555555546a <+330>:	lea    rsi,[rip+0xb93]        # 0x555555556004
   0x0000555555555471 <+337>:	lea    rdi,[rbp-0x21]
   0x0000555555555475 <+341>:	call   0x555555555070 <strcmp@plt>
   0x000055555555547a <+346>:	mov    DWORD PTR [rbp-0x10],eax
   0x000055555555547d <+349>:	mov    eax,DWORD PTR [rbp-0x10]
   0x0000555555555480 <+352>:	mov    DWORD PTR [rbp-0x54],eax
   0x0000555555555483 <+355>:	sub    eax,0xfffffffe
